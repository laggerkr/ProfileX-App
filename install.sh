...
apt-get update
apt-get install -y docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-compose-plugin`r`ncurl -fsSL https://deb.nodesource.com/setup_20.x | bash -`r`napt-get install -y nodejs
