...
export function logWarn(scope:LogScope,message:string,meta?:Record<string,unknown>){console.warn(JSON.stringify({time:new Date().toISOString(),scope,message,...meta}));}
